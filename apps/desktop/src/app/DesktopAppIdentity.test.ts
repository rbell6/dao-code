...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/Dao.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/Dao.app/Contents/Resources",
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Dao (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Dao (Alpha)");
