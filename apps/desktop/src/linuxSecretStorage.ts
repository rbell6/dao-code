...
function getGnomeKeyringRemediationMessage(): string {
  return "Dao could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Dao.";
}

function getKWalletRemediationMessage(): string {
  return "Dao could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Dao.";
}
