...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.jiraConnectionStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.jiraList]: AuthOrchestrationReadScope,
  [WS_METHODS.jiraDetail]: AuthOrchestrationReadScope,
  [WS_METHODS.jiraComment]: AuthOrchestrationOperateScope,
  [WS_METHODS.jiraTransition]: AuthOrchestrationOperateScope,
