...
/**
 * The palette Dao wears with no theme installed, captured from the app's
...
/**
 * The standard Dao look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Dao shows without a theme, read from the app's own
