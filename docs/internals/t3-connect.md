...
T3CODE_PORT=13773 \
  "/Applications/Dao (Alpha).app/Contents/MacOS/Dao (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/Dao (Alpha).app"
codesign -d --entitlements :- "/Applications/Dao (Alpha).app"
```
