...
> = {
  ...
  create_threads: ["Create", "Creating", "Created", "Dao threads"],
  t3_thread_start: ["Start", "Starting", "Started", "a Dao thread"],
  t3_thread_list: ["List", "Listing", "Listed", "Dao threads"],
  t3_thread_read: ["Read", "Reading", "Read", "a Dao thread"],
  t3_thread_send: ["Send", "Sending", "Sent", "to a Dao thread"],
  t3_thread_wait: ["Wait", "Waiting", "Waited", "for a Dao thread"],
  t3_thread_interrupt: ["Interrupt", "Interrupting", "Interrupted", "a Dao thread"],
