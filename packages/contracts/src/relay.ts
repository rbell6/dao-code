...
}).annotate({ description: "Links an authenticated cloud user to a Dao environment." });
...
export const RelayApi = HttpApi.make("RelayApi")
  ...
  .annotate(OpenApi.Title, "Dao Relay API")
  .annotate(OpenApi.Version, "1.0.0")
  .annotate(
    OpenApi.Description,
    "Control-plane API for linking Dao environments, connecting authorized clients, and publishing agent activity.",
  );
