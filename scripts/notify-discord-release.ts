  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Dao prerelease is available for nightly testers."
          : "A new Dao latest release is available.",
...
).pipe(Command.withDescription("Post a Dao release announcement to Discord."));
